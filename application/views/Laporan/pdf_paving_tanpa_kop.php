...
<body>
  ...
  <?php foreach ($pdf_data_all_paving as $row) : ?>
    ...
    <?php } else { ?>
      <strong>A. SYARAT & KETENTUAN</strong>
      <ol>
        <li>Harga SUDAH TERMASUK PENGIRIMAN ke lokasi dan PENURUNAN (FRANCO)</li>
        <?php foreach ($pdf_data_all_paving as $row) : ?>
          <?php if ($row['ppn'] == "Ya") { ?>
      ...
      <strong>B. Keterangan</strong>
      <ol>
        <li>Toleransi ukuran paving adalah +- 2 mm untuk dimensi Panjang dan tebal, +- 3 mm untuk tebal</li>
        <li>Segala bentuk penurunan lahan yang diakibatkan oleh pemadatan lahan bukan menjadi tanggung jawab PT BUMINDO SAKTI</li>
        <li>Jangka waktu penawaran berlaku 2 minggu sejak penawaran diterbitkan</li>
        <li>Kerusakan pada akses yang ditimbulkan armada pengiriman menjadi tanggung jawab pemberi tugas</li>
        <li>Pekerjaan dapat dilaksanakan setelah PO dikirimkan ke pihak kami</li>
        <li>Segala macam biaya perijinan, LSM, iuran merupakan tanggung jawab pemberi tugas</li>
  ...
  <table class="tabless" style="margin-top:55px">
    <thead>
      <?php foreach ($pdf_data_all_paving as $row) : ?>
        <?php if ($row['marketing'] == 'Harris') { ?>
          <tr>
