...
<body>
  ...
  <table class="tabless">
    <thead>
      <?php foreach ($table_th as $rew) : ?>
        <?php if ($rew->include == 'Tidak') { ?>
  ...
  <p>Demikian penawaran harga dari kami, besar harapan kami untuk menjalin kerjasama yang baik dengan bapak/ibu.</p>
