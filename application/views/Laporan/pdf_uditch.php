...
<body>
  ...
  <p align="center">
    PENAWARAN HARGA UDITCH
    <br>
    <b>No. <?php foreach ($pdf_data_all_uditch as $row) : ?><?= $row['no_surat'] ?><?php endforeach; ?>/
      <?php foreach ($pdf_data_all_uditch as $row) : ?>
        ...
        <?php } ?>
        <?php endforeach; ?>/
        <?php foreach ($pdf_data_bulan_uditch as $row) : ?>
          ...
          <?php } ?>
          <?php endforeach; ?>/
          <?php foreach ($pdf_data_tahun_uditch as $row) : ?><?= $row['tanggal'] ?><?php endforeach; ?>
  </p>
  <p align="right" style="font-weight:bold">Surabaya,
    <?php foreach ($pdf_data_tanggal_uditch as $row) : ?>
      <?= $row['tanggal'] ?>
    <?php endforeach; ?>
    <?php foreach ($pdf_data_bulan_uditch as $row) : ?>
      <?php if ($row['tanggal'] == '1') { ?>
  ...
  <table class="tabless">
    <thead>
      <tr>
        ...
        <th class="ths" style="text-align:left !important">Beban Gandar(Ton)</th>
    ...
    <tbody>
      <?php
      $no = 1;
      foreach ($pdf_data_permintaan_uditch as $row) :
      ?>
        <tr>
          <td class="tds"><?= $no++ ?></td>
          <td class="tds"><?= $row->item ?></td>
          <td class="tds"><?= $row->jumlah ?></td>
          <td class="tds"><?= $row->beban_gandar ?></td>
  ...
  <?php foreach ($pdf_data_permintaan_uditch as $row) : ?>
    <?= $row->keterangan; ?>
  <?php endforeach; ?>
      ...
      <?php foreach ($pdf_data_all_uditch as $row) : ?>
        ...
        <?php } elseif ($row['marketing'] == 'Mohamad') { ?>
          <tr>
            <td>
              <div style="position:relative;top:30px;left:-30px"><img src="./assets/ttd/stempel.png" style="width:120px"></div>
              <div style="position:absolute;top:10px"><img src="./assets/ttd/Mohamad.png" style="width:170px"></div>
            </td>
            <td align="right"></td>
          </tr>
        <?php } ?>
